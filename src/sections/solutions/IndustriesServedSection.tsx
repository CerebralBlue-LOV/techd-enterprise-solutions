      ...
      <div className="container-page">
        ...
        <div className="mt-10">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-secondary">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 min-h-[340px]">

              {/* Left: crossfading content panels */}
              ...
              {/* Right: industry selector list */}
              <div className="lg:col-span-5 flex items-center border-t lg:border-t-0 lg:border-l border-white/10">
                    ...
                    return (
                      <li key={it.ind.id}>
                        <button
                          ...
                          onFocus={() => setActive(i)}
                          onClick={() => setActive(i)}
                          className="group relative w-full text-left py-7 border-b border-white/10 flex items-center pl-5"
                        >
                          <span
                            aria-hidden
                            className={cn(
