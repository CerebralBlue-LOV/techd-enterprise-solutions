        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
          {extras.whyPoints.map((p, i) => (
            <Reveal key={p.title} delay={i * 60}>
              <div className="group flex h-full flex-col rounded-2xl bg-primary px-2 pt-3 pb-2 shadow-[0_8px_24px_-12px_hsl(var(--primary)/0.5)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_18px_36px_-14px_hsl(var(--primary)/0.6)]">
                <h3 className="px-3 pb-3 text-base font-bold leading-tight text-background">
                  {p.title}
                </h3>
