    ...
    >
      <Link
        ...
        className={`group relative block h-full w-full overflow-hidden rounded-2xl border bg-background transition-[transform,box-shadow,border-color] duration-100 ease-out ${
          isActive
            ? "border-border shadow-[0_20px_60px_-30px_hsl(var(--primary)/0.4),0_8px_20px_-16px_hsl(var(--primary)/0.18)] hover:scale-[0.98] hover:border-primary/60 hover:shadow-[0_0_30px_2px_hsl(var(--primary)/0.45),0_0_60px_8px_hsl(var(--primary)/0.18)]"
