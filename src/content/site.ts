...
export const CUSTOMERS: Customer[] = [
  ...
  { name: "Johns Hopkins Medicine", url: "https://www.hopkinsmedicine.org", logo: "/logos/johns-hopkins.png", logoClass: "h-12 md:h-14" },
  { name: "Princeton University", url: "https://www.princeton.edu", logo: "/logos/princeton-university.png" },
  { name: "DHS", url: "https://www.dhs.gov", logo: "/logos/dhs.svg", logoClass: "h-14 md:h-16" },
  { name: "L3Harris", url: "https://www.l3harris.com", logo: "/logos/l3harris.png" },
  { name: "Dominion Energy", url: "https://www.dominionenergy.com", logo: "/logos/dominion-energy.png", logoClass: "h-12 md:h-14" },
  { name: "Corning", url: "https://www.corning.com", logo: "/logos/corning.png", logoClass: "h-14 md:h-16" },
  { name: "CHOP", url: "https://www.chop.edu", logo: "/logos/chop.png", logoClass: "h-14 md:h-16" },
  ...
  { name: "The Kennedy Center", url: "https://www.kennedy-center.org", logo: "/logos/kennedy-center.png", logoClass: "h-14 md:h-16" },
