...
export const CUSTOMERS: Customer[] = [
  ...
  { name: "Stony Brook University", url: "https://www.stonybrook.edu", logo: "/logos/stonybrook.svg", logoClass: "h-6 md:h-7" },
  { name: "Mizuho", url: "https://www.mizuho-financial.com", logo: "/logos/mizuho.svg", logoClass: "h-10 md:h-12" },
  { name: "National University of Singapore", url: "https://www.nus.edu.sg", logo: "/logos/nus.svg", logoClass: "h-10 md:h-12" },
  { name: "Mercedes-Benz", url: "https://www.mercedes-benz.com", logo: "/logos/benz.svg", logoClass: "h-12 md:h-14" },
  { name: "Sicoob", url: "https://www.sicoob.com.br", logo: "/logos/sicoob.svg", logoClass: "h-8 md:h-9" },
  { name: "Itaú", url: "https://www.itau.com.br", logo: "/logos/itau.svg", logoClass: "h-12 md:h-14" },
  ...
  { name: "Admed", url: "https://www.admed.com.br", logo: "/logos/admed.svg", logoClass: "h-10 md:h-12" },
  ...
  { name: "Harvard University", url: "https://www.harvard.edu", logo: "/logos/harvard.svg", logoClass: "h-12 md:h-14" },
  { name: "Seagate", url: "https://www.seagate.com", logo: "/logos/seagate.svg", logoClass: "h-7 md:h-8" },
