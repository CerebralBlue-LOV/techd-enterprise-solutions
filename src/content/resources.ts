...
export const RESOURCES: Resource[] = [
  { id: "cs-1", type: "case-studies", title: "Global pharma cuts trial review by 62%", summary: "An agentic AI platform on IBM watsonx that reads protocols, surfaces risks, and routes decisions.", meta: "Healthcare · 6 min read" },
  ...
  { id: "wb-1", type: "webinars", title: "Building AI agents that pass an audit", summary: "60-minute walkthrough with TechD and IBM principal engineers.", meta: "On-demand" },
  { id: "wb-2", type: "webinars", title: "From data lake to data product", summary: "How to ship governed datasets the business will actually use.", meta: "On-demand" },

  { id: "ev-1", type: "events", title: "IBM Think 2026 — TechD lounge", summary: "Meet our principals at the Partner Pavilion.", meta: "Boston · May 2026" },
  { id: "ev-2", type: "events", title: "Enterprise AI roundtable, NYC", summary: "Closed-door session for CIOs and CDAOs.", meta: "New York · June 2026" },
];
